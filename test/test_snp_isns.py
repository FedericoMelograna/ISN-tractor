...
def test_dense():
    ...
    expected = pd.DataFrame(
        ...
        columns=["reg", "tar", 0, 1, 2, 3, 4, 5],
    )

    expected[0] = expected[0].astype(float32)
    expected[1] = expected[1].astype(float32)
    expected[2] = expected[2].astype(float32)
    expected[3] = expected[3].astype(float32)
    expected[4] = expected[4].astype(float32)
    expected[5] = expected[5].astype(float32)
